...
class moex_api:
    ...
    def get_securities(self, is_trading: int = 0) -> dict:
        return {
            'url': self.base_url.format('securities'),
    ...
    def get_markets(self) -> dict:
        """engine: str = 'stock'"""
        return {'url': self.base_url.format('engines/{engine}/markets')}

    def get_boards(self) -> dict:
        """ engine: str = 'stock', markets: str = 'shares'"""
        return {
    ...
    def sec_history_per_interval(
        ...
        return {
            'url': self.base_url.format(url_ending),
            'query_params': {
                'start_date': trade_begin.strftime(self.date_format),
                'end_date': trade_end.strftime(self.date_format),
            },
        }
